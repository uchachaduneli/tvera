...
public class AbonentController {
    ...
    /*ინსტალაციებს და ერთჯერად გადასახადებს არიცხავს ბალანსზე ნახადუ ღილაკით*/
    @RequestMapping({"/daricxva"})
    @ResponseBody
    public Response daricxva(@RequestParam Integer abonentId, Integer packageId, HttpServletRequest request) {
        abonentService.daricxva(abonentId, packageId, ((Integer) request.getSession().getAttribute("userId")));
        return Response.withSuccess(true);
    }
