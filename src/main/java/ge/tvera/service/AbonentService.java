...
//  }
    ...
    public void daricxva(Integer abonentId, Integer packageId, Integer userId) {
        ...
        if (obj != null && pack != null) {
            ...
            if (pack.getGroup().getId() == PackageDTO.INSTALLATION) {
                obj.setInstallationBill((obj.getJuridicalOrPhisical() == AbonentDTO.JURIDICAL ? pack.getJuridicalPrice() : pack.getPersonalPrice()));
            }
