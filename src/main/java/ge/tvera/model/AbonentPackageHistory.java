...
@Entity
@Table(name = "abonent_package_history", schema = "tvera")
public class AbonentPackageHistory {
    private Integer id;
    ...
    public AbonentPackageHistory(Abonent abonent, Package packages, Double juridicalPrice, Double phisicalPrice, Users user) {
