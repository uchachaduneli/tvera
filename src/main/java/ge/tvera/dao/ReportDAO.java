...
public class ReportDAO extends AbstractDAO {
    ...
    public HashMap<String, Object> getCountReport(AbonentDTO srchRequest) {
        ...
        if (srchRequest.getStatusId() != null) {
            ...
            abonentBalanceSumQuery += " and a.status.id ='" + srchRequest.getStatusId() + "'";
        }
        ...
        Double tmp = (Double) entityManager.createQuery(" Select sum(a.balance) From " + abonentBalanceSumQuery + " and a.balance < 0").getSingleResult();
        resultMap.put("abonentAvansSum", tmp != null ? tmp * -1 : 0.0);
        tmp = (Double) entityManager.createQuery(" Select sum(a.balance) From " + abonentBalanceSumQuery + " and a.balance > 0").getSingleResult();
        resultMap.put("abonentDavalSum", tmp != null ? tmp * -1 : 0.0);
