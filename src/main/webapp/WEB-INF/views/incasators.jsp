...
//        $scope.request.docs = [];
    ...
    $scope.loadMainData = function () {
      ...
      ajaxCall($http, "misc/get-incasators?start=" + $scope.start + "&limit=" + $scope.limit, angular.toJson($scope.srchCase), getMainData);
    }
    ...
    $scope.remove = function (id) {
      if (confirm("Pleace confirm operation?")) {
        if (id != undefined) {
          ...
          ajaxCall($http, "misc/delete-incasator?id=" + id, null, resFnc);
        }
      }
    };
    ...
    $scope.save = function () {
      ...
      ajaxCall($http, "misc/save-incasator", angular.toJson($scope.req), resFunc);
    };
        ...
        <div class="row">
          <form class="form-horizontal" name="ediFormName">
            ...
            <div class="form-group col-sm-10 ">
              ...
              <div class="col-sm-9">
                <input type="text" ng-model="request.lastname" name="lastname" required
                       class="form-control input-sm"/>
              </div>
            </div>
